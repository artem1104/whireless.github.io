...
$config_customizer = array(
	'recommended_plugins'       => array(
		'cactus-companion' => array(
			'recommended' => true,
			'description' => sprintf( esc_html__( 'If you want to take full advantage of the options this theme has to offer, please install and activate %s.', 'cactus' ), sprintf( '<strong>%s</strong>', 'Cactus Companion' ) ),
		),
	),
